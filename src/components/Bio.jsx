        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <p className="uppercase tracking-[0.3em] text-xs text-slate-500 mb-4">
              Modern Architecture • Timeless Calm
            </p>
            ...
            <p className="mt-6 text-lg leading-relaxed text-slate-700 max-w-2xl">
              I craft residences and commercial environments with a refined, minimalist sensibility. 
              Each project balances light, proportion, and materiality — creating calm, elevated places 
              for people to live and work. From feasibility through construction, I partner closely with 
              clients to realize clean, enduring architecture.
            </p>
